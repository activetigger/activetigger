...
export interface paths {
  ...
  '/generate/credentials': {
    ...
    /**
     * List Credentials
     * @description List the credentials visible to the current user (their own entries +
     *     instance entries), without the secrets
     */
  ...
  '/generate/credentials/{credentials_id}/models': {
     ...
     * @description List the models available with a credentials entry: the list declared
     *     in generative.yaml for instance entries that have one, otherwise the
     *     endpoint /v1/models
     */
  ...
  '/generate/postprocess/steps': {
     ...
     * @description Available post-treatment steps with the JSON schema of their parameters
     *     (lets the frontend build the step forms)
     */
  ...
  '/generate/pipelines/{pipeline_id}/sandbox': {
     ...
     *     Nothing is stored: the rows go back to the client.
     */
  ...
  '/generate/postprocess/preview': {
     ...
     *     (tune the post-treatment without calling the model again)
     */
  ...
  '/generate/pipelines/{pipeline_id}/start': {
    ...
    /**
     * Start Run
     * @description Launch a pipeline on a dataset sample (n_elements empty = the whole
     *     dataset). Returns the run id; outputs land in the run's file.
     */
...
export interface components {
  schemas: {
     ...
     *     None values are not sent to the provider.
     */
    GenerationParams: {
      /** Temperature */
    ...
    /**
     * PostprocessStep
     * @description One post-treatment step: a name from the registry + its parameters
     */
    PostprocessStep: {
      /** Name */
      name: string;
