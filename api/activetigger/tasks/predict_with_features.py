...
class PredictWithFeatures(BaseTask):
    """
    ...
    boundaries. The final prediction step counts as one more unit so the
    ...
    def __call__(self) -> DataFrame:
        ...
        try:
            ...
            self._raise_if_cancelled()
            features = pd.concat(frames, axis=1) if frames else DataFrame()
        ...
        if kind == "bert-embeddings":
            ...
            if model_path is None:
                raise ValueError(
                    ...
                    "(caller must resolve it before invoking PredictWithFeatures)"
                )
    ...
    def _raise_if_cancelled(self) -> None:
        ...
        __call__ so they can abort mid-embedding too.
        """
